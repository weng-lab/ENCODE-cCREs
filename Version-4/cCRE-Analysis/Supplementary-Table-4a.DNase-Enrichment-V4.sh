...
cat V2-V4.Filtered.bed V2-V4.New.bed > V4-New.bed
...
awk '{print $1 "\t" $2 "\t" $3 "\t" $4 "\t" $5 "\t" $6 "\t" $7 "\t" $8}' tmp.results > Table-Input-Data/Supplementary-Table-4a.DNase-Enrichment-V4-New.txt

inputList=Table-Input-Data/Supplementary-Table-4a.DNase-Enrichment-V4-New.txt
