...
dataDir=~/Lab/ENCODE/Encyclopedia/V6/Registry/V6-$genome
rdhs=$dataDir/$genome-rDHS/$genome-rDHS-Filtered.bed 
...
then
    prox=~/Lab/Reference/Human/$genome/GENCODE37/TSS.Basic.4K.bed
    tss=~/Lab/Reference/Human/$genome/GENCODE37/TSS.Basic.bed
